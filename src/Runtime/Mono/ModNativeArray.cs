...
namespace ECSExtension.Util
{
    ...
    public struct ModNativeArray<T> : IDisposable, IEnumerable<T>, IEnumerable, IEquatable<ModNativeArray<T>>, IList<T>
        where T : unmanaged
    {
        ...
        public unsafe ModNativeArray(int length, Allocator allocator, NativeArrayOptions options = NativeArrayOptions.ClearMemory)
        {
            ...
            if ((options & NativeArrayOptions.ClearMemory) != NativeArrayOptions.ClearMemory)
                return;
            UnsafeUtility.MemClear(m_Buffer, Length * (long)ModUnsafe.SizeOf<T>());
        }
        ...
        public unsafe ModNativeArray(NativeArray<T> array)
        {
            m_Buffer = array.m_Buffer;
            m_Length = array.m_Length;
            m_AllocatorLabel = array.m_AllocatorLabel;
        }
